namespace GrupoC_TP3.CU14_ValidarHDRenCDOrigen
{
    partial class CargaHojasdeRutaaDespacharenCDOrigen
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton.Location = new Point(149, 217);
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton.Margin = new Padding(3, 2, 3, 2);
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton.Name = "Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton";
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton.Size = new Size(131, 22);
            ...
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton.Click += Actualizar_Estado_Guia_a_Despachar_CD_Origen_Boton_Click;
            // 
            ...
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_ComboBox.Location = new Point(5, 217);
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_ComboBox.Margin = new Padding(3, 2, 3, 2);
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_ComboBox.Name = "Actualizar_Estado_Guia_a_Despachar_CD_Origen_ComboBox";
            Actualizar_Estado_Guia_a_Despachar_CD_Origen_ComboBox.Size = new Size(139, 23);
            ...
            Encomiendas_HDR_a_Despachar_CD_Orgien_listView.Groups.AddRange(new ListViewGroup[] { listViewGroup1 });
            Encomiendas_HDR_a_Despachar_CD_Orgien_listView.Location = new Point(5, 82);
            Encomiendas_HDR_a_Despachar_CD_Orgien_listView.Margin = new Padding(3, 2, 3, 2);
            Encomiendas_HDR_a_Despachar_CD_Orgien_listView.Name = "Encomiendas_HDR_a_Despachar_CD_Orgien_listView";
            Encomiendas_HDR_a_Despachar_CD_Orgien_listView.Size = new Size(699, 92);
            ...
            // 
            Hoja_Ruta_a_Despachar_CD_Origen_TextBox.Location = new Point(5, 20);
            Hoja_Ruta_a_Despachar_CD_Origen_TextBox.Margin = new Padding(3, 2, 3, 2);
            Hoja_Ruta_a_Despachar_CD_Origen_TextBox.Name = "Hoja_Ruta_a_Despachar_CD_Origen_TextBox";
            Hoja_Ruta_a_Despachar_CD_Origen_TextBox.Size = new Size(139, 23);
            Hoja_Ruta_a_Despachar_CD_Origen_TextBox.TabIndex = 1;
            // 
            // Ingreso_HDR_a_Despachar_CD_Origen_Boton
            // 
            Ingreso_HDR_a_Despachar_CD_Origen_Boton.Location = new Point(149, 18);
            Ingreso_HDR_a_Despachar_CD_Origen_Boton.Margin = new Padding(3, 2, 3, 2);
            Ingreso_HDR_a_Despachar_CD_Origen_Boton.Name = "Ingreso_HDR_a_Despachar_CD_Origen_Boton";
            Ingreso_HDR_a_Despachar_CD_Origen_Boton.Size = new Size(131, 22);
            ...
            // 
            Validar_HDR_a_Despachar_CD_Origen_Boton.Location = new Point(16, 336);
            Validar_HDR_a_Despachar_CD_Origen_Boton.Margin = new Padding(3, 2, 3, 2);
            Validar_HDR_a_Despachar_CD_Origen_Boton.Name = "Validar_HDR_a_Despachar_CD_Origen_Boton";
            Validar_HDR_a_Despachar_CD_Origen_Boton.Size = new Size(131, 22);
